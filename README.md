...
**Remember it like this: "copy" statement always transfers the `this` **
	
**Whether copied or not, the lexical scope and the "outer environment" of that function always remains the same**
